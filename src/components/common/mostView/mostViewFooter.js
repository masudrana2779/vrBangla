...
class MostViewFooter extends Component {
    render() {
        return (
                        ...
                        <div className="entry-image">
                            <a href="#"
                               title="These 7 things will change the way you approach travel">
                                <img src={MostView} alt="img"/>
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-7 col-xs-6 no-left-padding">
                        <div className="entry-header">
                            <h2 className="entry-title h7"><a href="#">These 7
                                things will change the way you approach travel</a></h2>
                        </div>
